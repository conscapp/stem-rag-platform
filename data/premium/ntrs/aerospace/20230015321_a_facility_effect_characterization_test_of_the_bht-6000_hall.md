---
title: "A Facility Effect Characterization Test of the BHT-6000 Hall Thruster"
source_type: ntrs
source_tier: premium
document_id: "20230015321"
publisher: NASA NTRS
domains:
  - aerospace
authors:
  - {'orcidId': '', 'name': 'Wensheng Huang'}
  - {'orcidId': '', 'name': 'James H. Gilland'}
  - {'orcidId': '', 'name': 'Daniel A. Herman'}
  - {'name': 'Lucy Zuo'}
  - {'name': 'Charlie Feng'}
  - {'name': 'Peter Wright'}
  - {'orcidId': '', 'name': 'Ian Johnson'}
  - {'name': 'Carl Mullins'}
  - {'name': 'Kurt Hohman'}
year: null
subject: engineering
